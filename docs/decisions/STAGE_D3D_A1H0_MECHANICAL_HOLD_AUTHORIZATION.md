...
After the execution-hardening review, exactly one guarded datacheck is
authorized with classification `stage_d3d_a1h0_datacheck_authorized`.
Solver submission, phase release, continuation, D3E, automatic retry, and
tolerance changes remain unauthorized.
