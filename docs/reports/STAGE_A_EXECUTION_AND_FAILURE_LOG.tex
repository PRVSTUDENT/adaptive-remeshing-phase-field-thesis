...
Matched-force comparisons against the approximate digitized Fig.~7 \(l_c=0.0075\ \mathrm{mm}\) curve were \(27.48\%\) high at \(U_2=0.002\ \mathrm{mm}\), \(4.98\%\) high at \(U_2=0.005\ \mathrm{mm}\), and \(11.55\%\) high at \(U_2\approx0.00599\ \mathrm{mm}\). The final \(U_2=0.0067\ \mathrm{mm}\) point lies outside the processed reference range.

This is not a final scientific pass. Gate A3 remains open pending supervisor-approved tolerances, review of \texttt{SDV15} decreases and late-stage overshoot, and uniform-reference justification. The current authorization has been consumed by the one completed execution; retry authorization is \texttt{none}.
