...
- [-] Perform mesh-size / h-convergence study. Scope authorized; three serial jobs submitted once. H0=`1376154.mmaster02`, H1=`1376155.mmaster02`, H2-PUB=`1376156.mmaster02` from revision `58d7e3102d76fe0e70e6729457e2c7e90ad131bb`. Scientific convergence pending. Evidence: `runs/hpc/molnar_lc015_h_convergence/STUDY_STATUS.md`; `runs/hpc/molnar_lc015_h_convergence/SUBMISSION_RECORD.txt`.
