...
- [x] P3-SM0 minimal-callback package and guarded serial lane prepared; exactly one serial execution is authorized through the guarded submitter from frozen preparation revision `a36e29285be86fe27c52fd0ffff163565684487d`, initially `0/1`, with no retry. Only constant LOP0/end, bounded UEL and UMAT markers are added; rank/thread calls, mutexes, diagnostic COMMON/shared monitors, P3-SM1, P3-T4, MPI, hybrid, P4, H1, D3D-A1 reopening and D3E remain blocked.
