...
- [!] D3D-A1H0 datacheck and solver submission are not authorized. Phase release, continuation, D3E, endpoint-union release, and tolerance changes remain prohibited.
