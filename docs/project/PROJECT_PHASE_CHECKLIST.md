...
- [x] P3-SM0 minimal-callback package and guarded serial lane prepared but unauthorized. Only constant LOP0/end, bounded UEL and UMAT markers are added; rank/thread calls, mutexes, diagnostic COMMON/shared monitors, P3-SM1, P3-T4, MPI, hybrid, P4, H1, D3D-A1 reopening and D3E remain blocked.
