...
- [-] Perform mesh-size / h-convergence study. Scope authorized and prepared: H0/H1/H2-PUB for exact supplementary `lc=0.015 mm` model only. Static validation pass; submission pending/next. Evidence: `docs/studies/MOLNAR_LC015_H_CONVERGENCE_PROTOCOL.md`; `results/validation/molnar_lc015_h_convergence/STUDY_EQUIVALENCE_DECISION.md`; `models/generated/molnar_gravouil_2017/h_convergence_lc015/`.
