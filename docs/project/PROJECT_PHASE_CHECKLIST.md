...
- [?] Exactly one P3-S serial diagnostic is authorized for submission through the guarded wrapper only: queue `entry_imfdfkmq`, CPU1, one rank/thread, 16 GB, 00:30:00, no retry. P3-T4 and all downstream routes remain blocked.
