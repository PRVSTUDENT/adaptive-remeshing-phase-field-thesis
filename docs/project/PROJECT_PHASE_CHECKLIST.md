...
- [-] Perform mesh-size / h-convergence study. First chain: H0=`1376154` solver_pass_cae_postprocess_failure; H1=`1376155` and H2=`1376156` dependency-cancelled. Authorized recovery: H0 CAE replay + first H1/H2 solves with fixed CAE/dependency handling. Evidence: `runs/hpc/molnar_lc015_h_convergence/recovery_after_job_1376154/RECOVERY_PLAN.md`.
