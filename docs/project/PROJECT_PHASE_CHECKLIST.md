...
- [ ] Build and validate D3A2 nonmatching target transfer package locally; no fracture solver submission until `runs/hpc/stage_d3/interrupted_transfer/package/D3_PACKAGE.ok` exists.
...
| State-transfer gate | controlled and fracture transfer pass | D1 analytical pass, D2A Abaqus ingestion pass, D2B serial continuation pass, D2C four-thread repeatability pass, D2D0 external-tool audit complete, and D3A accepted after scope-aware independent energy reconstruction | D2D blocked by missing ABAQUSER; D3A2 package and downstream fracture-relevant transfer not complete |
