...
- [?] Exactly one P3-SB serial baseline is authorized through the guarded wrapper: `0/1` used before submission, no automatic retry, and P3-SM plus all downstream authorities remain false.
