...
- [!] Original D3D-A1H0 datacheck authorization is consumed by job `1378003.mmaster02`. Only the separately authorized one-shot R1 datacheck may run after committed preparation. Full-hold solver submission, phase release, continuation, D3E, endpoint-union release, and tolerance changes remain prohibited.
