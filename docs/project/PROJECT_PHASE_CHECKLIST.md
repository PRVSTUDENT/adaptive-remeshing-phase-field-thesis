...
- [-] Perform mesh-size / h-convergence study. First chain failed at CAE/dependency. Recovery submitted: H0 CAE `1376184`, H1 `1376185`, H2 `1376186` from infrastructure `26b7b70` / scientific inputs `58d7e31`. Scientific convergence pending. Evidence: `runs/hpc/molnar_lc015_h_convergence/recovery_after_job_1376154/SUBMISSION_RECORD.txt`.
