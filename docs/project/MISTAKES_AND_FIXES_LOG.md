...
| 2026-07-23 | D3A3-R2 local prep | The first R2 local draft still had the old generator call path and a header in `d3_transfer_h.dat`, which would have sent the job back through the R1 compile-time table or caused a runtime read failure. | Local R2 source review before submission. | The generator now calls `generate_fortran_r2`; `d3_transfer_h.dat` is headerless, sorted, and validated with 25600 records and SHA256 `26a523475a6189dffc05706bf10406bf5df0490c62e56bc43609bddd8fd14160`. | Local compile/datacheck package prepared; cluster datacheck not yet submitted. |
