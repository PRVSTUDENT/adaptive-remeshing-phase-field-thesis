...
Gate A3 remains \texttt{reference\_data\_insufficient}. Candidate v2 has not
passed Gate A3. No new solution run, candidate v3, irreversibility-enforced
formulation, uniform-reference study, MISESERI workflow, adaptive-remeshing
run, or state-transfer task is authorized by the present evidence.
