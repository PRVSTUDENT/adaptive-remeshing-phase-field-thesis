...
claim. The next prepared test therefore uses only constant
\texttt{UEXTERNALDB}, UEL, and UMAT markers; rank/thread and mutex utilities
remain excluded and execution remains unauthorized.
