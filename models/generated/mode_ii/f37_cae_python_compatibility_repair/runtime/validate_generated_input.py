# Python 2 and 3 compatible generated input deck validator for F31
...
def main():
    source_path = sys.argv[1] if len(sys.argv) > 1 else os.environ.get('F31_SOURCE_DECK', 'runtime/source_deck.inp')
    generated_path = sys.argv[2] if len(sys.argv) > 2 else os.environ.get('F37_OUTPUT_INPUT', 'M2RMPROV4.inp')
