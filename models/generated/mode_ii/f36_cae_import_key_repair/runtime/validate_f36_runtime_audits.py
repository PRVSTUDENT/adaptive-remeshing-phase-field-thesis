# Python 2 and 3 compatible aggregate runtime audit validator for F36
...
def main():
    ...
    if len(failures) == 0:
        print("SUCCESS: All F36 runtime audits passed.")
        sys.exit(0)
    else:
        print("ERROR: F36 runtime audit validation failed:")
