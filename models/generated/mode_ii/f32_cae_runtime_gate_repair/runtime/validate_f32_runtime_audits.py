# Python 2 and 3 compatible aggregate runtime audit validator for F32
...
def main():
    ...
    if len(failures) == 0:
        print("SUCCESS: All F32 runtime audits passed.")
        sys.exit(0)
    else:
        print("ERROR: F32 runtime audit validation failed:")
