#!/bin/python3
"""
Runtime Validator for F43PRE1 Standard Mechanical Pre-Analysis Job.
"""
...
def validate_f43pre1_runtime(evidence_dir):
    sta_path = os.path.join(evidence_dir, "F43PRE1.sta")
    msg_path = os.path.join(evidence_dir, "F43PRE1.msg")
    odb_path = os.path.join(evidence_dir, "F43PRE1.odb")
    ...
    out_status_path = os.path.join(evidence_dir, "F43PRE1_VALIDATION_STATUS.json")
...
if __name__ == "__main__":
    ...
    passed = validate_f43pre1_runtime(evidence_dir)
