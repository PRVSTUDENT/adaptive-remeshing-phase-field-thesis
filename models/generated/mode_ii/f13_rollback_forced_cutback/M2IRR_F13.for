...
C       F13 diagnostic-only controlled cutback: only PNEWDT changes.
        PBEFORE=PNEWDT
...
C     ==================================================================
      ...
      IF (NELEMAN.LT.1.OR.NELEMAN.GT.N_ELEM) THEN
       WRITE(7,*) 'F13 BOUNDS DISP',JELEM,N_ELEM,NELEMAN
       CALL XIT
      ENDIF
...
C
       ...
       IF (NELEMAN.LT.1.OR.NELEMAN.GT.N_ELEM) THEN
        WRITE(7,*) 'F13 BOUNDS UMAT',NOEL,N_ELEM,NELEMAN,NPT
        CALL XIT
       ENDIF
       IF (NPT.LT.1.OR.NPT.GT.4) THEN
        WRITE(7,*) 'F13 BOUNDS NPT',NOEL,NPT
        CALL XIT
       ENDIF
       IF (NPT.EQ.3) THEN
        NPT=4
