...
# Guarded submission wrapper for M2REF_ONEEL_FRACFIX_VERIFY_R2
# Protocol version: 1
...
echo "Submitting M2REF_ONEEL_FRACFIX_VERIFY_R2 to PBS..."
qsub M2REF_ONEEL_FRACFIX_VERIFY_R2.pbs
