# Python 2 and 3 compatible aggregate runtime audit validator for F31
...
def main():
    ...
    if len(failures) == 0:
        print("SUCCESS: All F31 runtime audits passed.")
        sys.exit(0)
    else:
        print("ERROR: F31 runtime audit validation failed:")
