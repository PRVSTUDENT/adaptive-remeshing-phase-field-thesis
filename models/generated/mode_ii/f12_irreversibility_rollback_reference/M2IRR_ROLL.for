...
C      
       ...
       IF (JELEM.LT.1.OR.JELEM.GT.N_ELEM) THEN
        WRITE(7,*) 'F12 BOUNDS PHASE',JELEM,N_ELEM
        CALL XIT
       ENDIF
C     ==================================================================
...
C     Consistent quadrature-point penalty for d_(n+1) >= d_n.
     ...
     1   (DP(1)*DP(1)+DP(2)*DP(2))
        ...
        IF (JELEM.LE.2.AND.INPT.LE.2.AND.STEPITER.LE.40) THEN
...
C     ==================================================================
      ...
      IF (NELEMAN.LT.1.OR.NELEMAN.GT.N_ELEM) THEN
       WRITE(7,*) 'F12 BOUNDS DISP',JELEM,N_ELEM,NELEMAN
       CALL XIT
      ENDIF
...
C
       ...
       IF (NELEMAN.LT.1.OR.NELEMAN.GT.N_ELEM) THEN
        WRITE(7,*) 'F12 BOUNDS UMAT',NOEL,N_ELEM,NELEMAN,NPT
        CALL XIT
       ENDIF
       IF (NPT.LT.1.OR.NPT.GT.4) THEN
        WRITE(7,*) 'F12 BOUNDS NPT',NOEL,NPT
        CALL XIT
       ENDIF
       IF (NPT.EQ.3) THEN
        NPT=4
