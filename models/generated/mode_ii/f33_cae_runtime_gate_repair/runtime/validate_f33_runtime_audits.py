# Python 2 and 3 compatible aggregate runtime audit validator for F33
...
def main():
    ...
    if len(failures) == 0:
        print("SUCCESS: All F33 runtime audits passed.")
        sys.exit(0)
    else:
        print("ERROR: F33 runtime audit validation failed:")
