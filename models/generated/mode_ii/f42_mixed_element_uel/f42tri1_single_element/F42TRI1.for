C ======================================================================
C F42TRI1: Single-Element 3-Node Triangular Layered UEL Verification Subroutine
C ======================================================================
     ...
     5     JPROPS(*)
       ...
       INTEGER I,J,L,K,K1,K2,K3,K4,INPT,INODE
     ...
     4 XII_T(3,2),W_T(3),ULOC_Q(8),ULOC_T(6)
       ...
       REAL*8 EG,EG2,ELAM,DPHI,DEG,PARK_VAL
...
C     ==================================================================
     ...
     2     (BP_T(1,I)*BP_T(1,J)+BP_T(2,I)*BP_T(2,J)))
          END DO
         END DO
         USRVAR(JELEM,1,INPT)=PHASE
         USRVAR(JELEM,2,INPT)=HIST
        END DO
        RETURN
       ENDIF
...
C     ==================================================================
     ...
     2   EPS(3)*CMAT(3,3)*EPS(3))
         IF (ENG.GT.USRVAR(NELEMAN,13,INPT)) THEN
          USRVAR(NELEMAN,13,INPT)=ENG
         END IF
         WT_FAC=THCK*DTM*W_T(INPT)
         DO I=1,6
          DO J=1,3
