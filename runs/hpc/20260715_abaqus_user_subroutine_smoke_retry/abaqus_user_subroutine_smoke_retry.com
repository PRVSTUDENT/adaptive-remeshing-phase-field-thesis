...
options = {
    ...
    'input':'abaqus_user_subroutine_smoke',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'abaqus_user_subroutine_smoke_retry',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'rezone':OFF,
    'runCalculator':OFF,
    'scratch':'/scratch/pr21vyci/adaptive-remeshing/runs/abaqus_user_subroutine_smoke_retry_1374533.mmaster02/abaqus_scratch',
    'simPack':OFF,
    'soils':OFF,
    'soliter':OFF,
    'solverTypes':['DIRECT'],
    ...
    'thermal':OFF,
    'tmpdir':'/scratch/pr21vyci/adaptive-remeshing/runs/abaqus_user_subroutine_smoke_retry_1374533.mmaster02/abaqus_scratch',
    'tracer':OFF,
    'transientSensitivity':OFF,
    'unfold_param':OFF,
    'unsymm':OFF,
    'user':'uexternaldb_smoke_getoutdir.for',
    'visco':OFF,
    'xplSelect':OFF,
}
