...
| 6.000000e-03 | `Step-2` | 4 | 6.000000e-03 | 2.669660e-01 | 1.969872e-01 | 1.475316e-01 |
| 7.000000e-03 | `Step-2` | 8 | 7.000000e-03 | 3.063210e-01 | 2.986702e-01 | 2.646088e-01 |
...
```text
     JOB TIME SUMMARY
       USER TIME (SEC)      =     0.31    
       SYSTEM TIME (SEC)    =     6.00E-02
       TOTAL CPU TIME (SEC) =     0.37    
       WALLCLOCK TIME (SEC) =            1
1

   Abaqus 2023                                  Date 28-Jul-2026   Time 08:29:33
```

```text
     JOB TIME SUMMARY
       USER TIME (SEC)      =     8.72E+02
       SYSTEM TIME (SEC)    =      23.    
       TOTAL CPU TIME (SEC) =     8.95E+02
       WALLCLOCK TIME (SEC) =          965
```
