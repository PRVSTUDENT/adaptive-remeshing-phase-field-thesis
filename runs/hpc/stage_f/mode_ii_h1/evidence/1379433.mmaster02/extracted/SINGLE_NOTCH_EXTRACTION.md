...
- ***WARNING: DEGREE OF FREEDOM 1 IS NOT ACTIVE ON NODE 12149 INSTANCE PART-1-1 - THIS BOUNDARY CONDITION IS IGNORED
- ***WARNING: DEGREE OF FREEDOM 1 IS NOT ACTIVE ON NODE 12149 INSTANCE PART-1-1 - THIS BOUNDARY CONDITION IS IGNORED
...
```text
     JOB TIME SUMMARY
       USER TIME (SEC)      =     0.65    
       SYSTEM TIME (SEC)    =     9.00E-02
       TOTAL CPU TIME (SEC) =     0.74    
       WALLCLOCK TIME (SEC) =            1
1

   Abaqus 2023                                  Date 28-Jul-2026   Time 10:08:51
```

```text
     JOB TIME SUMMARY
       USER TIME (SEC)      =     2.43E+03
       SYSTEM TIME (SEC)    =      50.    
       TOTAL CPU TIME (SEC) =     2.48E+03
       WALLCLOCK TIME (SEC) =         2564
```
