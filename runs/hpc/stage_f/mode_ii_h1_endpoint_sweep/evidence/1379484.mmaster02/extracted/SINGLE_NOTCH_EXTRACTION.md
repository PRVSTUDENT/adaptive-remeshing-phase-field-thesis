...
- ***WARNING: THE *ELEMENT OUTPUT OPTION IS NOT SUPPORTED FOR USER ELEMENTS *Step, name=Step-2, nlgeom=NO, inc=14000
- ***WARNING: AN OUTPUT REQUEST AT EXACT TIME POINTS IS NOT SUPPORTED IN AN ANALYSIS WITH DIRECT INCREMNTATION. IT WILL BE CHANGED TO AN
- ***WARNING: THE *ELEMENT OUTPUT OPTION IS NOT SUPPORTED FOR USER ELEMENTS
...
```text
     JOB TIME SUMMARY
       USER TIME (SEC)      =     1.54E+04
       SYSTEM TIME (SEC)    =     3.36E+02
       TOTAL CPU TIME (SEC) =     1.57E+04
       WALLCLOCK TIME (SEC) =        16112
```
