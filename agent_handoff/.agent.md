...
- Molnar lc015 h-convergence study prepared: H0 exact author inputs verified; H1/H2-PUB static validation passed with publication-resolution verified for H2-PUB. Physical elements H0=3930, H1=12064, H2-PUB=33852. Measured corridor h medians approximately 0.00494 / 0.0025 / 0.001 mm. Fig. 7 lc=0.015 corrected-origin reference under `references/derived/molnar_gravouil_2017/single_notch/fig7_lc015_corrected_origin/`.

Immediate next tasks:

1. Commit, push, synchronize HPC clone, and submit exactly three serial HPC jobs for Molnar `lc=0.015 mm` h-convergence: H0, H1, H2-PUB.
