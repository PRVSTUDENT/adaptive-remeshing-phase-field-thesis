...
- Exactly one P3-SB serial baseline submission is authorized through the guarded wrapper only. Authorization is `0/1`, automatic retry is false, and the frozen lane remains `entry_imfdfkmq`, CPU/rank/thread `1/1/1`, 16 GB, 00:30:00. P3-SM, P3-T4, MPI, hybrid, P4, production H1, D3D-A1 reopening and D3E remain unauthorized.
