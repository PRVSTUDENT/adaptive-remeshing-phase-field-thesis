...
6. Resolve the `817` SDV15 above-precision non-staggered events categorized as `insufficient_mapping_evidence` before declaring SDV15 irreversibility clean.
