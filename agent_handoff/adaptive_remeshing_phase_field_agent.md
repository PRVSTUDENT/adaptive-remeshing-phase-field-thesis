...
- P3-SB-A isolated replay passed every unchanged frozen gate and is classified `stage_p3sb_finalized_evidence_offline_pass`; the original job/status remain `stage_p3sb_baseline_serial_fail_validation`, status SHA `54d15323295cf712f50a26e5194b28a61826a3803374c4342b61ca8c546653de`, with no original completion marker and no rerun. Exactly one P3-SM0 serial execution is authorized through the guarded submitter from frozen preparation revision `a36e29285be86fe27c52fd0ffff163565684487d`; authorization starts at `0/1`, automatic/manual retry is prohibited, and the lane has constant LOP0/end, UEL and UMAT markers only with no rank/thread calls, mutex, diagnostic COMMON/shared monitor, or scientific calculation change. P3-SM1 and all downstream lanes remain blocked.
