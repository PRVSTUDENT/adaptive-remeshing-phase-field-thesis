...
At this checkpoint no diagnostic PBS job has yet been submitted in this log entry. Gate A3 remains \texttt{reference\_data\_insufficient}, and the only permitted next solve is the single prepared serial diagnostic submission after HPC-side preflight passes.
