...
| `crack_path_comparison.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_check/crack_path_comparison.csv` | 975 | `88cdf487420184afffc92faadbaaf37e5dac2db13ba1fe48bf4365b0c20e70d2` |
| `crack_path_threshold_metrics.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/crack_path_threshold_metrics.csv` | 3407 | `171339b6380072fd75f462db1a5e11e7af921c91989a67ba8348539bc7e497be` |
| `extract_molnar_sdv15_detailed_events.py` | `scripts/postprocessing/extract_molnar_sdv15_detailed_events.py` | 41989 | `0b99eb7078f71a28e64ab882800c7e2b1d4220b1d4497ce63a26ac26830ec5b7` |
...
| `extraction_metadata.json` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/sdv15_detailed_review/extraction_metadata.json` | 1227 | `a374ce4d074d5ea879d3460ac872143200648e396abf82b7e437308455763bc0` |
| `FIG7_COMPARISON_AUDIT.md` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/FIG7_COMPARISON_AUDIT.md` | 1079 | `1f43eff4647f1340c483c82e86679d9a48ea6c2095c780f2ea52d4d85aa06c66` |
| `fig7_comparison_metrics.json` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/fig7_comparison_metrics.json` | 1350 | `50dafafecfdce758a2329003873a6ad339a367d90a56aa68fdfa4160671240d0` |
...
| `RESPONSE_STATE_SELECTION.md` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/RESPONSE_STATE_SELECTION.md` | 1041 | `e56a112326cff8ddf2d9723fd25bb8af88c6825a5a9e084bff28dd38a42b62ad` |
...
| `rf_u_curve_comparison.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_check/rf_u_curve_comparison.csv` | 469 | `1d951d4c943ad957fc1bede1662bcd348eb3aa8dd19589f5f9b8279cdafb70e4` |
...
| `RUN_MANIFEST.md` | `(not resolved uniquely)` | 12585 | `6aa13d6e236ebf317f39bd0a39bd3cf73631ff7596c75e98fd3737b56bbf3ee0` |
| `RUN_SUMMARY.md` | `(not resolved uniquely)` | 3454 | `4c3f9f2eae51fe4cd8a4844cd9e0765b1630ec77299eed814add4b9f3f68d84f` |
| `SCIENTIFIC_DECISION.md` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/SCIENTIFIC_DECISION.md` | 12072 | `db9feabd404f79f1958da762a1a2bfaeeee18c862826b5a4126723fa21052199` |
| `SCIENTIFIC_REVIEW_SUMMARY.md` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/SCIENTIFIC_REVIEW_SUMMARY.md` | 2729 | `ad3a605d743d11b80984350248b7368eb3a6a0bcbcd39dbefa3205cd0b83afb7` |
...
| `sdv15_decrease_events_full.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/sdv15_detailed_review/sdv15_decrease_events_full.csv` | 3504134 | `6b089e4ff08d43d5eb4865fd7af0f6276aef2da8741f245d06b078c0cbcde366` |
...
| `SDV15_WORST_EVENT_AUDIT.md` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/sdv15_detailed_review/SDV15_WORST_EVENT_AUDIT.md` | 927 | `9f5f045298b85eeed4a7634c74d72aa8920e02095a38eb610ec354aac4f4addc` |
| `sdv15_worst_event_history.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/sdv15_detailed_review/sdv15_worst_event_history.csv` | 140242 | `cd82693f6d53920f9ad4ef46c644681147cb48bc00e7e7a066de02f6cb6a5b72` |
| `sdv16_at_sdv15_event_locations.csv` | `runs/hpc/paper_matched_single_notch_v2/scientific_review/sdv15_detailed_review/sdv16_at_sdv15_event_locations.csv` | 98915 | `33e05205f7d961ecaa5394a2864558c2169249374cd8d07ac249b24a76e3093d` |
...
| `SINGLE_NOTCH_EXTRACTION.md` | `runs/hpc/paper_matched_single_notch_v2/extracted/SINGLE_NOTCH_EXTRACTION.md` | 2930 | `4c09c7b31d7f7e5efd29610885a443716aba0b73fa1812a64dab2e032617b532` |
| `single_notch_extraction_summary.json` | `runs/hpc/paper_matched_single_notch_v2/extracted/single_notch_extraction_summary.json` | 4306 | `ecb2529ca6515f5661a5d5da86f24da1ca25701d88b74f1e5b36aa7e79513f0f` |
| `single_notch_matched_displacement_states.csv` | `runs/hpc/paper_matched_single_notch_v2/extracted/single_notch_matched_displacement_states.csv` | 695 | `6794e310c027f436d1cd347bf96ba429a2dc56a90846246ee6c3e1e71f58cd7b` |
| `single_notch_rf_u_phase_summary.csv` | `runs/hpc/paper_matched_single_notch_v2/extracted/single_notch_rf_u_phase_summary.csv` | 33882 | `71d9af8ea3b80e8e1d003f9eb5f9bd3b07b6c0aee3444029cabfaa1a0da82ec7` |
| `single_notch_scientific_check.json` | `runs/hpc/paper_matched_single_notch_v2/scientific_check/single_notch_scientific_check.json` | 9608 | `96edb9020af8fe3ad4f087b778d85e4e973648b93503b355b463fe8559ad2641` |
