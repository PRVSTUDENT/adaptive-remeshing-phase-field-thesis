...
- [-] Perform mesh-size / h-convergence study. Recovery solvers H1=`1376185` / H2=`1376186` may still finish; H0 CAE `1376184` failed on argv. Env-var CAE I/O repair prepared; one future consolidated CAE-only job authorized after H1/H2 inactive. Evidence: `runs/hpc/molnar_lc015_h_convergence/recovery_after_job_1376154/CONSOLIDATED_CAE_REPLAY_PLAN.md`.
