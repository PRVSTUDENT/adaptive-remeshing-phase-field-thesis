...
Exact next checklist item: `[?] Supervisor decision on Gate A3 tolerances, approximate Fig. 7 reference acceptability, post-peak RF-U mismatch interpretation, and whether additional SDV15 completed-phase-state evidence is required`.
