...
- [-] Perform mesh-size / h-convergence study. Solvers H0/H1/H2 technical pass; consolidated CAE-only job `1376236.mmaster02` submitted once for all three ODBs from `bd09bc4`. Scientific convergence pending CAE results. Evidence: `runs/hpc/molnar_lc015_h_convergence/recovery_after_job_1376154/cae_replay_all/SUBMISSION_CHECKPOINT.md`.
