#!/usr/bin/env python3
"""Generate publication-quality figures for Mode-II H0 endpoint-corrected serial solver run 1379393.mmaster02.
"""
...
EVIDENCE_DIR = ROOT / "runs/hpc/stage_f/mode_ii_h0_endpoint_corrected/replacement_r1/evidence/1379393.mmaster02"
FIGURES_DIR = ROOT / "results/figures/mode_ii_h0_endpoint_corrected/1379393.mmaster02"
...
def main():
    ...
    ax.plot(u1_vals, rf1_vals, color="#1f77b4", linewidth=2.0, label=r"Mode-II $H_0$ ($N_{\mathrm{elem}}=3930$)")
    ...
    ax.set_title(r"Mode-II Pure Shear Baseline Response ($H_0$, Endpoint-Corrected)", fontsize=11)
    ...
    ax.set_title(r"Mode-II Phase-Field Damage Evolution ($H_0$)", fontsize=11)
    ax.grid(True, linestyle="--", alpha=0.6)
    ax.legend(loc="upper left", fontsize=10)
