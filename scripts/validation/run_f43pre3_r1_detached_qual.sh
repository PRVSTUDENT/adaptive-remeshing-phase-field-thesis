#!/bin/bash
# Linux-Git detached worktree qualification script for P43PRE3-R1
set -euo pipefail

TARGET_P="${1:-2c73cbb007a1aa8ffbeab421eb199723ec0b2184}"
REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"

WORKTREE_DIR="/tmp/f43pre3_r1_qual_worktree"
SCRATCH_DIR="/tmp/f43pre3_r1_qual_scratch"

echo "=== F43PRE3-R1 DETACHED QUALIFICATION STARTING ==="
...
if [ "${DETACHED_HEAD}" != "${TARGET_P}" ]; then
    echo "FATAL: Detached HEAD mismatch! Target=${TARGET_P}, Actual=${DETACHED_HEAD}" >&2
...
echo "F43PRE3_R1_DETACHED_QUALIFICATION_SUCCESS"
