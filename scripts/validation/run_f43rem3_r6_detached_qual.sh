#!/bin/bash
# Linux-Git detached worktree qualification script for P43REM3-R6 / Q43REM3-R6
set -euo pipefail

TARGET_P_SHA="${1:-P43REM3-R6}"
REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"

echo "=== F43REM3-R6 DETACHED WORKTREE QUALIFICATION ==="
echo "Target P SHA: ${TARGET_P_SHA}"

WORKTREE_DIR="$(mktemp -d /tmp/f43rem3_r6_qual_worktree_XXXXXX)"
SCRATCH_DIR="$(mktemp -d /tmp/f43rem3_r6_qual_scratch_XXXXXX)"
...
echo "=== F43REM3-R6 DETACHED QUALIFICATION SUCCESS ==="
