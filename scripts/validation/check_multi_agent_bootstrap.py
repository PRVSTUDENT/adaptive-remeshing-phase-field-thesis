...
ALLOWED_TASK_IDS = frozenset(
    {
        ...
        "F5-H2-COMPILER-DATACHECK-SMOKE-SUBMIT",
        "F5-SSH-TRANSPORT-RECOVERY-PREFLIGHT",
        "F5-H2-COMPILER-DATACHECK-SMOKE-EXECUTE",
        "F6-H2-FULL-AND-MISESERI-REMESH-API-BATCH",
        "F9-DATACHECK-ROOT-CAUSE-AND-REMESH-TYPE-BATCH",
        "F10-CORRECTED-MINIMAL-IRREVERSIBILITY-AND-REMESH-TYPE-BATCH",
        "F11-INSTRUMENTED-IRREVERSIBILITY-AND-REMESH-TYPE-BATCH",
        "F12-ROLLBACK-QUALIFICATION-AND-NATIVE-REMESH-PREPARATION",
        "F13-CONTROLLED-ROLLBACK-AND-FIRST-NATIVE-REMESH-EXECUTION",
        "F14-RUNTIME-LOAD-AND-ADAPTIVE-REGION-QUALIFICATION",
        "F14-TERMINAL-MONITORING-AND-QUALIFICATION-CLOSEOUT",
        "F15-DUAL-CHANNEL-NOTIFICATION-QUALIFICATION",
        "F15-F16-CONDITIONAL-BATCH-PREPARATION",
        "F15-F16-CONDITIONAL-BATCH-WAVE-A-EXECUTION",
        "F16-WAVE-B-EXECUTION-WITH-EMAIL-GATE-WAIVER",
        "F16-QUEUE-ACCESS-QUALIFICATION-AND-WAVE-B-REPLACEMENT-PREPARATION",
        "F16-R3-ROUTED-QUEUE-BATCH-EXECUTION",
        "F17-PENALTY-ACTIVATION-AND-ADAPTIVE-REGION-REPAIR-PREPARATION",
        "F17-PBS-FINAL-LF-REPAIR-AND-CLEAN-LINUX-QUALIFICATION",
        "F17-CANONICAL-PROBE-LF-REPAIR-AND-HASH-FREEZE",
        "F17-ADAPTIVE-LEGACY-MANIFEST-REPAIR-AND-FINAL-QUALIFICATION",
        "F17-FINAL-PROBE-LF-QUALIFICATION-AND-TWO-JOB-EXECUTION",
        "F19-AUTHORIZED-THREE-JOB-EXECUTION",
        "F19-GUARDED-ORCHESTRATOR-ENV-EXPORT-REPAIR",
        ...
        "F24-OFFICIAL-ADAPTIVE-CONTRACT-AND-ODB-COMPATIBILITY-GATE",
        "F25-REPAIR-GEOMETRY-BACKED-PROVISIONAL-PACKAGE",
        "F26-INVALIDATE-F25-AND-PREPARE-CAE-BUILD-QUALIFICATION",
        "F27-INVALIDATE-F26-AND-REPAIR-CAE-BUILD-PACKAGE",
        "F28-INVALIDATE-F27-AND-COMPLETE-REAL-CAE-BUILD-PACKAGE",
        "F29-INVALIDATE-F28-AND-PREPARE-TOPOLOGY-SAFE-CAE-BUILD",
        "F30-INVALIDATE-F29-AND-REPAIR-RUNTIME-CAE-GATE",
        "F30-REMOTE-SYNC-AND-VERIFICATION",
        "F31-INVALIDATE-F30-AND-REPAIR-M2RMBUILD5-STATIC-GATE",
        "F31-M2RMBUILD6-REPLACEMENT-AUTHORIZED-SUBMISSION",
        "F31-CORRECT-M2RMBUILD6-AUTHORIZATION-RECORD",
        "F32-INVALIDATE-F31-AND-REPAIR-M2RMBUILD6-WORK-DIR-STAGING-GATE",
        "F32-M2RMBUILD7-AUTHORIZED-SUBMISSION",
        "F33-M2RMBUILD8-OFFLINE-REPAIR",
        "COORD-0",
        "COORD-1",
        "COORD-1R",
        "F1-P0",
        ...
        "F1-J1",
        "F41-CRACK-GEOMETRY-RECONSTRUCTION-QUALIFICATION",
        "F41R1-SURGICAL-ABAQUS-RUNTIME-CORRECTION",
        "F41R2-FINAL-ABAQUS-API-COMPATIBILITY-CORRECTION",
        "F41R3-ABAQUS-NO-GUI-ENTRYPOINT-FIX",
        "F41R4-ASSIGNSEAM-REGION-CORRECTION",
        "F41R4-M2RMSTITCH1-FINAL-SUBMISSION-AUTHORIZATION",
        "F41R4-M2RMSTITCH1-FINAL-SUBMISSION-EXECUTION",
        "F41R4-M2RMSTITCH1-FINAL-JOB-1384642-EVALUATION",
        "F41R5-FREE-QUADRILATERAL-SEAM-MESHING",
        "F41R6-ADAPTIVE-REMESHING-COMPATIBILITY-GATE",
        "F42A-MIXED-TRIANGLE-QUADRILATERAL-UEL-ARCHITECTURE-FOUNDATION",
        "F42A-R1-MIXED-UEL-CONTRACT-CORRECTION",
        "F42B-SINGLE-TRIANGLE-UEL-CORE-VERIFICATION",
        "F42C-TRIANGLE-CPE3-FACSIMILE-MAPPING",
        "F42D-MIXED-QUAD-TRI-PATCH-INTEGRATION",
        "F43A-STAGE-C-NATIVE-REMESHING-BRIDGE",
        "F43B-F43PRE1-GATE-C0-REVIEW-AND-F43REM1-READINESS",
        "F43REM1-SUBMISSION-EXECUTION-AND-CLOSEOUT",
        "F43REM1-EVIDENCE-ONLY-MONITORING-AND-LINEAGE-CLASSIFICATION",
        "F43REM1-PREDECESSOR-ODB-IDENTITY-RESOLUTION-AND-TERMINAL-EVIDENCE-CLASSIFICATION",
        "F43REM1-TERMINAL-MONITORING-ODB-HASH-RESOLUTION-AND-SCIENTIFIC-CLOSEOUT",
        "F43REM1-REMOTE-ODB-HASH-VERIFICATION-AND-TRUE-TERMINAL-CLOSEOUT",
        "F43REM1-JOB-1384675-TERMINAL-MONITORING-AND-FINAL-EVIDENCE-CLOSEOUT",
        "F43REM1-R1-CURRENT-PREDECESSOR-REMOTE-SUBMISSION-REPAIR",
        "F43REM1-R1-EXACT-P43R1-DETACHED-QUALIFICATION-CORRECTION",
        "F43REM1-R1-IMMUTABLE-EXACT-BLOB-CLEAN-LINUX-QUALIFICATION",
        "F43REM1-CURRENT-GUARDED-REMOTE-HPC-SUBMISSION-AND-EVIDENCE-CLOSEOUT",
        "F43REM1-R2-ABAQUS-CAE-ENVIRONMENT-VARIABLE-DRIVER-CONTRACT-REPAIR",
        "F43REM1-R2-GUARDED-REMOTE-HPC-SUBMISSION-AND-EVIDENCE-CLOSEOUT",
        "F43REM1-R3-GEOMETRY-BACKED-CAE-MODEL-PROVENANCE-AUDIT-AND-FALSE-ZERO-EXIT-REPAIR",
        "F43GEO1-PARAMETRIC-GEOMETRY-SOURCE-RECONSTRUCTION",
        "F43GEO2-GEOMETRY-BACKED-CAE-GENERATION-AND-ADAPTIVITY-ELIGIBILITY-GATE",
        "F43PRE2-Q1-EXTERNAL-CAE-FREEZE-AND-EXACT-PREPARATION-QUALIFICATION",
        "F43PRE2-R1-FINAL-ON-DISK-CAE-HASH-CONTRACT-FREEZE-QUALIFICATION",
        "F43PRE2-R2-IMMUTABLE-CAE-SOURCE-WORK-COPY-CONTRACT-AND-DETACHED-QUALIFICATION",
        "F43PRE2_GEOM",
        "F43PRE2_GEOM_AUTHORIZATION_BOUNDARY_REVIEW",
        "F43PRE2_GEOM_AUTHORIZATION_AND_SUBMISSION",
        "F43PRE2-GEOM-GUARDED-SUBMISSION-AND-EVIDENCE-CLOSEOUT",
        "F43PRE2-SCI1",
        "F43REM2_NATIVE",
        "F43REM2_NATIVE_SUBMISSION",
        "F43REM2-R3",
        "F43REM2-R3-LQ1",
        "F43REM2-R3-LQ2",
        "F43REM2-R3-LQ3",
        "F43REM3_NATIVE_REPLACEMENT_EXECUTION",
        "F43REM3-R8",
        "F43REM3-R8FWD1",
        "F43REM3-R8FWD2",
        "F43MODEREF7-PAIR1R-SUBMIT1",
        "F43MODEREF-VERIFY-SUBMIT2",
        "F43MODEREF7-ANCHORRECOVERY1",
        "F43MODEREF-H0IDENTITY-FIX1",
        "F43MODEREF-VERIFY-CLOSEOUT2",
        "F43MODEREF-FRACFIX-BATCHREADY3",
        "F43MODEREF-FRACFIX-BATCHREADY2",
        "F43MODEREF-VERIFY-SUBMIT1",
        "F43MODEREF12-PAIR2-SUBMIT1",
        "F43MODEREF13-PAIR2-PBSFIX-PREP1",
        "F43MODEREF13-PAIR2-SUBMIT1",
        "F43MODEREF13-QUAL-EVIDENCE-AUDIT1",
        "F43MODEREF13-PAIR2-CLOSEOUT1",
        "F43MODEREF13-PAIR2-CENSORING-CLAIMAUDIT1",
        "F43ADAPT-COMPARE-CONTRACT1",
        "F43ADAPT-PROD-PREP1",
    }
)
