...
from validate_p3sm1r_submission_preflight import REQUIRED_FALSE, validate_authorization
...
def consume(path: Path, job_id: str, revision: str) -> dict[str, object]:
    ...
    data.update({
        "classification": "stage_p3sm1r_getrank_serial_submitted",
        "p3sm1r_submission_authorized": False,
        "p3sm1r_submissions_used": 1,
        "p3sm1r_job_id": job_id,
        "p3sm1r_submitted_revision": revision,
    })
...
def main() -> int:
    ...
    try:
        ...
        print(f"P3-SM1R authorization consumption blocked: {exc}")
        return 20
    print(f"P3-SM1R authorization consumed: {result['p3sm1r_job_id']}")
    return 0
