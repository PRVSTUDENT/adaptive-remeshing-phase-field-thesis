...
- D3A3-R2 full job `1377396.mmaster02` was submitted exactly once from commit `7a860f50fe557cd88cd3299dd47b1f260071f3fa`. Abaqus compiled, linked, completed input processing, completed Standard analysis, and produced ODB/extraction outputs, but strengthened validation failed with `Exit_status=21`. Classification: `stage_d3a3_r2_full_validation_fail`; failures include SDV15 transfer max error `0.018013543321948218`, SDV16 transfer max error `0.01645326664671945`, checkpoint U2 only `0.0014999968154910865`, RF release jump `1.0292182958543674`, d-healing violations `4651`, max phase adjustment `0.013784315224591115`, and missing phase-node values for reconstructed energy. Evidence root: `runs/hpc/stage_d3/interrupted_transfer/target_ingestion_r2/`. No `D3A3.ok`; D3D/D3E remain blocked. No retry is authorized.
