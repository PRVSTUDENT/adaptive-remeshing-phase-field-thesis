...
- D3A3-R4 compatibility-closure lane prepared in isolated `executable_r4_compatible_r2/` using only `package_compatible_r2` (active 6446 / free 155). Runtime-H SHA256 `e4e2b2773c7c29161f4c99bbd7218fa6fe49c6ec3e48d6c2107f83419e97e07c` (not R3 hash). Fortran byte-identical to accepted R3. Static validation passed; serial R4 datacheck job `1377468.mmaster02` passed (`stage_d3a3_r4_compatible_datacheck_pass`; H LOAD COMPLETE 25600; Step-3 BC 6446/0). Marker `target_ingestion_r4_compatible_datacheck/D3A3_R4_DATACHECK.ok`. Full R4 hold remains blocked until explicitly authorized; D3D/D3E remain blocked until canonical `D3A3.ok`.
