...
- Stage D3A0/D3A1 audited the existing accepted H0 ODB `1376154.mmaster02` and extracted the `U2=0.003000000026077032 mm` checkpoint in CAE/ODB-only jobs. The final extractor attempt `1376879.mmaster02` produced 15720 element/IP rows, `target_ip_coverage=1.0`, finite `SDV15`/`SDV16`, `max_d=0.08412302285432816`, `max_H=0.0512588769197464`, checkpoint `RF2=0.39450356364250183`, and `RF2/H0_peak=0.5421925638518931`, but D3A is not accepted because the source ODB lacks `ALLIE`, `ALLSE`, and `ALLWK` energy history. Classification: `stage_d3a_checkpoint_blocked_missing_energy_history`; no `D3A.ok`, no D3A2 package, no fracture solver submission.
- Stage D3A-E independent energy reconstruction was authorized in `docs/decisions/D3A_ENERGY_EVIDENCE_ROUTE.md` and run as CAE/ODB-only job `1376885.mmaster02` after cancelling slow extractor attempt `1376882.mmaster02`. Reconstruction completed with `external_work=0.0005994580560459379`, `bulk_energy_from_SDV12=0.0005918856529030076`, `bulk_energy_from_stress_strain=0.0005918856524092704`, relative SDV12-vs-S:E difference `8.341766862422363e-10`, total fracture energy `2.280704034757352e-08`, total reconstructed internal energy `0.0005919084599433551`, and relative energy residual `0.012594035606728515`. Validation failed because five Jacobian determinants from the accepted H0 deck connectivity were non-positive; classification `stage_d3a_energy_reconstruction_fail`, no `D3A.ok`, no D3A2 package, no fracture solver submission.
