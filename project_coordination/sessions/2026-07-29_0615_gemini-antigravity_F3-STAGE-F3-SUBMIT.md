...
4. **Remote Execution:** Updated HPC workspace `/home/pr21vyci/projects/adaptive-remeshing` to latest main commit and launched both jobs via SSH:
   - **Candidate Job A (Mode-II H2 Uniform Reference Serial):**
     ...
     - **Telegram notification:** `telegram_ok event=SUBMITTED job=1379578.mmaster02`
   - **Candidate Job B (Pandey-Kumar MISESERI Pre-Analysis):**
     ...
     - **Telegram notification:** `telegram_ok event=SUBMITTED job=1379579.mmaster02`
5. **Scheduler Verification:** Confirmed both jobs active in `qstat -u pr21vyci` (State: `R` RUNNING). Recorded active jobs in `HPC_JOB_LEDGER.csv` and updated coordination state to `stage_f3_submitted`.
...
|---|---|---|---|---|---|
| `1379578.mmaster02` | `mode_ii_h2_serial` | `models/generated/mode_ii/h2_uniform_serial` | 1 CPU, 16 GB, 12:00:00 | Running (`R`) | `559e060988224874fd18328ef2eb7eac2aab23f1adebcbeac3c6664787e209d6` |
| `1379579.mmaster02` | `mode_ii_miseseri_preanalysis` | `models/generated/mode_ii/miseseri_preanalysis` | 1 CPU, 16 GB, 01:00:00 | Running (`R`) | `484edd39e6930758346764e5e183b5fd050577bdb6b11ede5cba49b955307fe9` |

---

## 3. Execution Boundary

- Active Job IDs: `["1379578.mmaster02", "1379579.mmaster02"]`
