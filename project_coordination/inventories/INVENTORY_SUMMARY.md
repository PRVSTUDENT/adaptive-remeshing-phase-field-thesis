...
- `1386447.mmaster02`: M2REF_H1_FRACFIX ($N_{\text{phys}}=12064$, $h/l_0=1.0$) completed Step-1 (500 increments) and reached Step-2 inc 1854 ($u_x = 0.009632\text{ mm}$, $RF_1 = 0.36166\text{ kN}$, $d_{\max} = 0.99752$) before solver divergence under fixed incrementation (`Exit_status = 1`); 17 lightweight evidence files inventoried and archived.
- `1386448.mmaster02`: M2REF_H2_FRACFIX ($N_{\text{phys}}=33852$, $h/l_0=0.5$) completed Step-1 (500 increments) and reached Step-2 inc 1743 ($u_x = 0.009250\text{ mm}$, $RF_1 = 0.35408\text{ kN}$, $d_{\max} = 0.99847$) before reaching the 4-hour PBS walltime limit (`Exit_status = -29`); 16 lightweight evidence files inventoried and archived.
