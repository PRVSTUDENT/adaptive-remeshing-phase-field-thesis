...
- Stage P0--P2 was selectively committed and pushed as `9369dfcb05d63cdbdec0b0e910423c9a6cc7bd1c`; P3-S preparation was pushed as `08fe3afc26f840e06601e6d0a6990c0a39c9ca34`. The first synchronized cluster preflight launched no job and exposed that default `python3` rejects future annotations. The guarded submit/PBS paths now bind qualified `python/gcc/11.4.0/3.11.7`; repeat preflight is required. The thesis subsection builds in the 28-page Tectonic closeout. P3-S execution, P3-T4, MPI, hybrid, production H1, D3D-A1 reopening, and D3E remain blocked.
