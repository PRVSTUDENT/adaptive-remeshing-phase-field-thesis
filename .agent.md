...
- Stage P0--P2 was selectively committed and pushed as `9369dfcb05d63cdbdec0b0e910423c9a6cc7bd1c`; P3-S preparation was pushed as `08fe3afc26f840e06601e6d0a6990c0a39c9ca34`. Synchronized preflight launched no job. Qualified Python 3.11.7 fixed the first compatibility block. The audit replay then exposed line-ending churn and, separately, that the frozen 365-record local P1 scope contains relevant untracked variants absent from the cluster. Audit regeneration is now opt-in (`--refresh-audit`) so P3 preflight cannot rewrite frozen P1 evidence. Clean synchronized replay remains required; all execution remains blocked.
